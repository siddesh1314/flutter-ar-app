...
class _ARScreenState extends State<ARScreen> {
  ...
  void updateNode(Vector3 newPosition, Vector3 newScale) {
    if (imageNode != null) {
      setState(() {
        imageNode!.position = newPosition; // Update position
        imageNode!.scale = newScale; // Update scale
      });
              ...
              children: [
                ...
                IconButton(
                  ...
                  onPressed: () {
                    if (imageNode != null) {
                      updateNode(
                        Vector3(imageNode!.position.x,
                            imageNode!.position.y + 0.1, imageNode!.position.z),
                        imageNode!.scale,
                      );
                    }
                  },
